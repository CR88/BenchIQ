      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900">
            Create your <span className="text-blue-600">BenchIQ</span> account
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Get started with your repair shop management system
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  This will set your default location preferences for addresses, phone numbers, and other regional settings.
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
                  placeholder="you@yourrepairshop.com"
                />
              </div>
